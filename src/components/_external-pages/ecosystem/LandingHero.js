        ...
        <Container maxWidth="lg">
          <ContentStyle>
            ...
            <Box style={{ marginTop: '20px' }}>
              ...
              >
                EQUITY is the utility token of Backed Capital's protocol. Commissions are not paid with this token but 
                you need to have it to use the platform.The more tokens you have, the lower the commissions will be!
                <br />
                <br />
